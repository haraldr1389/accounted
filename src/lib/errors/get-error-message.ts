...
const FOREIGN_KEY_REFUSAL_MAP: Record<string, Bilingual> = {
  depreciation_schedules_journal_entry_id_fkey: {
    ...
    no: 'Bilaget bokfører et avskrivning i anleggsmiddelregisteret og kan ikke slettes. Utfør en retting (storno) i stedet.',
  },
}
...
const POSTGRES_ERROR_MAP: Record<string, Bilingual> = {
  ...
  'PT409': { sv: 'En konflikt uppstod. Ladda om sidan och försök igen.', en: 'A conflict occurred. Reload the page and try again.', no: 'Det oppstod en konflikt. Last siden på nytt og prøv igjen.' },
