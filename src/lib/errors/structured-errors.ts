...
const INVOICE: Record<string, StructuredErrorEntry> = {
  ...
  CASH_ACCOUNT_DISABLE_PRIMARY: {
    ...
    message_no: 'Dette er foretakets primære bankkonto og kan ikke slås av. Velg «Gjør primær» på en annen bankkonto først.',
  ...
  CASH_ACCOUNT_DISABLED_PAYEE: {
    ...
    message_no: 'Bankkontoen er slått av og vises på fakturaene. En eier eller administrator må slå den på under Innstillinger før transaksjoner kan legges på den.',
  ...
  CASH_ACCOUNT_PRIMARY_INELIGIBLE: {
    ...
    message_no: 'Kontoen kan ikke være primær. Den primære kontoen må være en aktiv bankkonto i SEK (konto 1920-1999).',
  ...
  CASH_ACCOUNT_DISABLE_UNRESOLVED: {
    ...
    message_no: 'Kontoen har uoppgjorte transaksjoner og kan ikke slås av før de er bokført eller ignorert.',
  ...
  CASH_ACCOUNT_ENABLED_BANK_MANAGED: {
    ...
    message_no: 'Kontoen hører til en banktilkobling. Slå den av eller på via banktilkoblingen i stedet.',
...
const PERIOD: Record<string, StructuredErrorEntry> = {
  ...
  YEAR_END_DISPOSITIONS_WRONG_LEGAL_FORM: {
    ...
    message_no: 'Årsavslutningsdisposisjoner etter svensk regelverk (periodiseringsfond, överavskrivningar, bolagsskatt, särskild löneskatt) støttes ikke for foretakets selskapsform.',
    message_en:
  ...
  EF_DECLARATION_WRONG_LEGAL_FORM: {
    ...
    message_no: 'Beregningene i NE-bilaga etter svensk regelverk (egenavgifter, räntefördelning, periodiseringsfond, expansionsfond) gjelder bare enkeltpersonforetak, ikke foretakets selskapsform.',
    message_en:
...
const VAT_FILING: Record<string, StructuredErrorEntry> = {
  VAT_FILING_PERIOD_NOT_ENDED: {
    ...
    message_no: 'Perioden er ikke avsluttet ennå og kan ikke markeres som innsendt.',
  ...
  VAT_FILING_DATE_BEFORE_PERIOD_END: {
    ...
    message_no: 'Innsendingsdatoen er før periodens slutt.',
  ...
  VAT_FILING_CONFIRMED_BY_SKATTEVERKET: {
    ...
    message_no: 'Perioden er sendt inn via Skatteverket-tilkoblingen med kvittering og kan ikke markeres som ikke sendt inn.',
    message_en:
...
const BANK_FILE: Record<string, StructuredErrorEntry> = {
  ...
  BANK_FILE_INVALID_SETTLEMENT_ACCOUNT: {
    ...
    message_no: 'Bankkontoen må være en aktiv konto i kontoklasse 19 i kontoplanen din.',
  ...
  BANK_FILE_SETTLEMENT_ACCOUNT_UNAVAILABLE: {
    ...
    message_no: 'Den valgte bankkontoen kan ikke brukes til denne filen. Ingenting ble importert.',
...
const BANK_SYNC: Record<string, StructuredErrorEntry> = {
  ...
  BANK_RATE_LIMITED: {
    ...
    message_no: 'Banken begrenser for øyeblikket hvor ofte transaksjoner kan hentes. Vent til next_allowed_at. Tilkoblingen trenger ikke fornyes.',
...
const DOCUMENT: Record<string, StructuredErrorEntry> = {
  ...
  ARKIV_NOT_ENABLED: {
    ...
    message_no: 'Arkiv er ikke aktivert for dette foretaket ennå.',
...
const SALARY: Record<string, StructuredErrorEntry> = {
  ...
  SALARY_RUN_CORRECT_NOT_BOOKED: {
    ...
    message_no: 'Bare bokførte lønnskjøringer kan korrigeres (rättelsekörning).',
  ...
  SALARY_RUN_ALREADY_CORRECTED: {
    ...
    message_no: 'Lønnskjøringen er allerede korrigert; jobb videre i korrigeringskjøringen.',
  ...
  SALARY_REGISTER_DATES_LOCKED_BY_RUN: {
    ...
    message_no: 'Datoene inngår i avvikelsesperioden til en lønnskjøring som allerede er beregnet, godkjent eller bokført. Sett kjøringen tilbake til utkast, eller kjør en rättelsekörning, før fravær eller timer arbeidet endres.',
    message_en:
  ...
  SALARY_RUN_DEVIATION_PERIOD_INVALID: {
    ...
    message_no: 'Ugyldig avvikelsesperiode: oppgi både start- og sluttdato (ÅÅÅÅ-MM-DD), start før slutt, maks to måneder.',
    message_en:
  ...
  SALARY_RUN_DEVIATION_PERIOD_OVERLAP: {
    ...
    message_no: 'Avvikelsesperioden overlapper en annen lønnskjøring: de samme fraværsdagene ville blitt trukket to ganger. Oppgi en avvikelsesperiode som ikke overlapper, eller endre innstillingen før neste nye måned.',
    message_en:
  ...
  SALARY_RUN_PAYMENT_FILE_NOT_READY: {
    ...
    message_no: 'Betalfil kan bare genereres etter godkjenning (status approved, paid eller booked).',
  ...
  SALARY_RUN_PAYMENT_FILE_MISSING_BANK_DETAILS: {
    ...
    message_no: 'Foretakets bankopplysninger som betalfilen trenger mangler eller er ugyldige: IBAN og BIC for ISO 20022 (pain.001), bankgironummer for Bankgirot LB. Fyll dem inn under Innstillinger → Fakturering.',
    message_en:
  ...
  SALARY_RUN_PAYMENT_FILE_EMPLOYEE_BANK_MISSING: {
    ...
    message_no: 'En eller flere ansatte med nettoutbetaling mangler clearingnummer eller kontonummer. Fullfør bankopplysningene under Ansatte.',
    message_en:
  ...
  SALARY_RUN_PAYMENT_FILE_EMPLOYEE_BANK_INVALID: {
    ...
    message_no: 'En eller flere ansatte har bankopplysninger som betalfilen ikke kan ta med. details.employees viser hvem og hva som må rettes.',
    message_en:
  ...
  SALARY_RUN_PAYMENT_FILE_GENERATION_FAILED: {
    ...
    message_no: 'Betalfilen kunne ikke lages: kontroller bankopplysningene til foretaket og de ansatte.',
...
const PROVIDER: Record<string, StructuredErrorEntry> = {
  PROVIDER_CONFIGURATION_ERROR: {
    ...
    message_no: 'Fortnox-tilkoblingen må rettes av Accounted. Kontakt supporten. Du trenger ikke koble til på nytt.',
...
const LINK_SI_VOUCHER: Record<string, StructuredErrorEntry> = {
  ...
  LINK_SI_VOUCHER_NO_BANK_CREDIT: {
    ...
    message_no: 'Bilaget krediterer ikke en kasse- eller bankkonto (19xx), så det kan ikke vare betalingen av fakturaen. Velg bilaget der pengene forlot kontoen.',
    message_en:
  ...
  LINK_SI_VOUCHER_FULLY_ALLOCATED: {
    ...
    message_no: 'Bilagets utbetaling er allerede knyttet til andre leverandørfakturaer og har inget beløp igjen. Velg et annet bilag.',
    message_en:
  ...
  LINK_SI_VOUCHER_CUTOFF_ALREADY_POSTED: {
    ...
    message_no: 'Årsavslutningens periodisering etter kontantmetoden er allerede bokført for et år som omfatter både fakturaen og betalingen, og den regnet fakturaen som ubetalt. Rett periodiseringen først (storno og bokfør på nytt), knytt så bilaget.',
    message_en:
...
const ASSETS: Record<string, StructuredErrorEntry> = {
  ...
  ASSET_DELETE_BLOCKED: {
    ...
    message_no: 'Anleggsmiddelet kan ikke slettes fordi det er ført i regnskapet: avskrivninger er bokført eller eiendelen er avhendet. Registerposten er da regnskapsinformasjon (BFL 7 kap.). Bruk avhendelse, eller føre tilbake bilaget med storno først.',
    message_en:
  ...
  K3_REQUIRED_FOR_COMPONENTS: {
    ...
    message_no: 'Komponentinndeling (k3_components) krever at foretaket anvender K3 (BFNAR 2012:1).',
    message_en:
  ...
  INVALID_K3_COMPONENTS: {
    ...
    message_no: 'Komponentinndelingen er ugyldig: komponentenes anskaffelseskostnader skal summere seg til eiendelens anskaffelseskostnad.',
    message_en:
